...
public class FreedomCRM extends AplicativoPD {
	...
	public FreedomCRM() {
		...
		addOpcao( 200000000, TP_OPCAO_MENU, "Listes", "", 'L', 200300000, 1, false, null );
		...
		addOpcao( 300000000, TP_OPCAO_MENU, "Listes", "", 'L', 300300000, 1, false, null );
		...
		addOpcao( 400000000, TP_OPCAO_MENU, "Listes", "", 's', 401000000, 1, false, null );
		...
		addOpcao( 500000000, TP_OPCAO_MENU, "Listes", "", 'L', 500200000, 1, false, null );
