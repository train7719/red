...
public class FreedomGPE extends AplicativoPD {
	...
	public FreedomGPE() {
		...
		addOpcao( 100100000, TP_OPCAO_ITEM, "changements", "changements", 'T', 100100100, 2, true, FTurnos.class );
		addOpcao( 100100000, TP_OPCAO_ITEM, "Funções", "Funções", 'F', 100100200, 2, true, FFuncao.class );
		addOpcao( 100100000, TP_OPCAO_ITEM, "Départements", "Départements", 'D', 100100300, 2, true, FDepto.class );
		addOpcao( 100100000, TP_OPCAO_ITEM, "Employés", "Employés", 'E', 100100400, 2, true, FEmpregado.class );
		addOpcao( 100100000, TP_OPCAO_ITEM, "Employeurs", "Employeurs", 'p', 100100500, 2, true, FEmpregadores.class );
		addOpcao( 100100000, TP_OPCAO_ITEM, "Benefícios", "Enregistrement de Benefícios", 'b', 100100600, 2, true, FBeneficio.class );

		addSeparador( 100100000 );
		addOpcao( 100100000, TP_OPCAO_ITEM, "Etat civil", "Etat civil", 's', 100100700, 2, true, FEstadoCivil.class );
		addSeparador( 100100000 );
		addOpcao( 100100000, TP_OPCAO_ITEM, "Feriados", "Enregistrement de Feriados", 'r', 100100800, 2, true, FFeriados.class );
		...
		addOpcao( 200000000, TP_OPCAO_ITEM, "Enregistrement de Faltas", "Enregistrement de Faltas", 'F', 200300000, 1, true, FFalta.class );
