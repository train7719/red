...
public class FreedomPCP extends AplicativoPD implements ActionListener {
	...
	public FreedomPCP() {
		...
		addSeparador( 200000000 );
		addOpcao( 200000000, TP_OPCAO_MENU, "Listes", "", 'L', 200900000, 1, false, null );
		...
		addOpcao( 200900000, TP_OPCAO_MENU, "Listes FSC", "", 'F', 201000000, 1, false, null );
		...
		addSeparador( 400000000 );
		addOpcao( 400000000, TP_OPCAO_MENU, "Listes", "", 'L', 400700000, 1, false, null );
