...
public class FRExtrato extends FRelatorio {
	...
	public FRExtrato() {
		...
		adic( new JLabelPad( "N� conta" ), 7, 100, 80, 20 );
		adic( txtCodConta, 7, 120, 90, 20 );
		adic( new JLabelPad( "Descri��o da conta" ), 100, 100, 200, 20 );
	...
	public void imprimir( TYPE_PRINT bVisualizar ) {
		...
		if ( temAcessoConta() ) {
			...
			Funcoes.mensagemInforma( this, "Voc� n�o possui acesso a essa conta!" );
		}
	...
	public void imprimiTexto( ResultSet rs, TYPE_PRINT bVisualizar, String sCab ) {
		...
		try {
			...
			imp.limpaPags();
			imp.setTitulo( "Extrato Banc�rio" );
			imp.addSubTitulo( "EXTRATO BANC�RIO" );
	...
	private void imprimiGrafico( final ResultSet rs, final TYPE_PRINT bVisualizar, final String sCab ) {
		...
		if ( bVisualizar==TYPE_PRINT.VIEW ) {
			...
			try {
				...
				Funcoes.mensagemErro( this, "Erro na impress�o de Extratos de contas!" + err.getMessage(), true, con, err );
			}
		}
	}
}
