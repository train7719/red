...
public class FFDialogo extends JDialog implements ActionListener, KeyListener, IFilho {
	...
	public JButtonPad btCancel = new JButtonPad("Annuler", Icone.novo("btCancelar.png"));
...
/*		if (comScroll) {
	...
	*/	
	...
	public void setToFrameLayout() {
		...
		JButtonPad btSair = new JButtonPad("Quitter", Icone.novo("btSair.png"));
